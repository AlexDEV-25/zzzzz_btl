        ...
        <nav class="bg-white relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
            ...
            <div class="flex-1 flex items-center justify-center lg:justify-start gap-6">
                ...
                <div class="hidden lg:flex space-x-8">
                    <a href="<?php echo _WEB_HOST; ?>?module=home&action=admin" class="font-medium text-gray-700 hover:text-gray-800">Trang chủ</a>
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    <div class="relative text-end">
                        ...
                        <div id="user-menu" class="hidden absolute right-0 mt-2 w-48 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 py-1">
                            ...
                            <a href="<?php echo _WEB_HOST; ?>?module=home&action=admin" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Trang admin</a>
                            <a href="<?php echo _WEB_HOST; ?>?module=home&action=dashboard&userId=1" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Trang chủ</a>
